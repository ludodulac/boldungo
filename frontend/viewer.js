...
function applyNoticeAssemblyStep(index){
  ...
  frameNoticePlacements([...state.before,...state.added],visualActionPrototype?'perspective-left':'perspective',visualActionPrototype?1.06:1.22);
